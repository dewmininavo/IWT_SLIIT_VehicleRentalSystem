...
<body>
    ...
    <div class="container">
        ...
        <form action="employSignin.php" method="post">
            ...
            <input type="password" id="password1" placeholder="Create New Password" name="password" required>

            <label for="confirm-password"><b>Confirm Password</b></label>
            <input type="password" id="password2" placeholder="Confirm Password" name="confirm-password" required>
